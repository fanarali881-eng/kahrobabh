        ...
        <div className="bh-footer-social">
          <div className="bh-container">
            <div className="bh-footer-social-inner">
              ...
              <div className="bh-footer-social-right" style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                <span className="bh-footer-social-label" style={{ marginBottom: '12px' }}>تابعونا</span>
